...
void I18n::InitStrings() {
    ...
    tr[StrId::CtxRename]            = L"✏ Yeniden Adlandır\tF2";
    tr[StrId::DlgRenameTitle]       = L"Yeniden Adlandır";
    tr[StrId::DlgRenamePrompt]      = L"Yeni dosya adını girin:";
    tr[StrId::CtxDeleteKeepFile]    = L"🗑 Listeden Kaldır (Dosya Kalsın)";
    tr[StrId::CtxDeleteWithFile]    = L"❌ Diskten de Sil...";
    tr[StrId::DlgDeleteKeepFileCheck]= L"İndirilen dosyayı da diskten kalıcı olarak sil";
    tr[StrId::DlgDeleteConfirmPrompt]= L"Seçili görevi listeden kaldırmak istediğinize emin misiniz?";
    tr[StrId::DlgDeleteMultiplePrompt]= L"%d adet seçili görevi listeden kaldırmak istediğinize emin misiniz?";
    ...
    en[StrId::CtxRename]            = L"✏ Rename\tF2";
    en[StrId::DlgRenameTitle]       = L"Rename Task / File";
    en[StrId::DlgRenamePrompt]      = L"Enter new filename:";
    en[StrId::CtxDeleteKeepFile]    = L"🗑 Remove from List (Keep File)";
    en[StrId::CtxDeleteWithFile]    = L"❌ Delete File from Disk...";
    en[StrId::DlgDeleteKeepFileCheck]= L"Permanently delete downloaded file from disk as well";
    en[StrId::DlgDeleteConfirmPrompt]= L"Are you sure you want to remove the selected task?";
    en[StrId::DlgDeleteMultiplePrompt]= L"Are you sure you want to remove %d selected tasks?";
